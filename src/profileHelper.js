...
function generateProfileImageHex(image, gradientcolor1, gradientcolor2) {
	// We need to generate random id's for the svg's otherwise they will conflict with eachother
	function random() {
...
>
	<path
		...
		fill="url(#pattern${id3})"
		stroke="url(#paint${id2}_linear_24_3)"
		stroke-width="17"
	/>
	<defs>
		<pattern
